<template>
    ...
    <div class="projectContainer" v-motion-slide-visible-bottom>
        <div class="blogBox">
            <div class="topBox">
        ...
        <div class="blogBox">
            ...
            <div class="blogTitle">
                Decided to work on building UI for a student portal. Stack Used: HTML, Tailwind CSS, JavaScript
            </div>
        </div>
        <div class="blogBox">
            <div class="topBox">
...
<script>
    import Button from './button_bl.vue'
    export default{
        name: "Projects",
        components: {
            Button,
